...
function menu.load()
      --Create Menu 1 
      menu.addMenu(0,0,60,25,"File",menu.menuFont,false,false,false,200,25,false,nil,menu.submenuFont,
      ...
      --Create Menu 2 
      menu.addMenu(60,0,60,25,"Edit",menu.menuFont,false,false,false,210,25,false,nil,menu.submenuFont,
      ...
      --Create Menu 3 
      menu.addMenu(120,0,60,25,"Build",menu.menuFont,false,false,false,200,25,false,nil,menu.submenuFont,
      ...
      --Create Menu 4 
      menu.addMenu(180,0,90,25,"Windows",menu.menuFont,false,false,false,170,25,false,nil,menu.submenuFont,
      ...
      --Create Menu 5 
      menu.addMenu(270,0,60,25,"Tools",menu.menuFont,false,false,false,125,25,false,nil,menu.submenuFont,
      ...
      --Create Menu 7 
      menu.addMenu(440,0,80,25,"Layouts",menu.menuFont,false,false,false,125,25,false,nil,menu.submenuFont,
      ...
      --Create Menu 8 
      menu.addMenu(520,0,60,25,"Help",menu.menuFont,false,false,false,190,25,false,nil,menu.submenuFont,
      ...
      --Create Menu 9 
      menu.addMenu(580,0,125,25,"Source Control",menu.menuFont,false,false,false,180,25,false,nil,menu.submenuFont,
      {
...
function menu.addMenu(x,y,w,h,name,menuFont,open,disabled,hovered,
    ...
    {   x = x , y = y , width = w , height = h ,    name = name ,       menuFont = menuFont,
        open = open or false,       disabled = disabled or false,       hovered = hovered or false,
        submenus = nil or
                { 
                    width = submenusWidth or 0,                 height = submenusHeight or 0,  
                    submenuHovered = submenuHovered or false,   submenuHoveredIndex = submenuHoveredIndex or nil,
                    submenuFont = submenuFont,                  menus = menuItems or {}
                }
    }))
end
